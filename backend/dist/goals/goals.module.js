...
exports.GoalsModule = GoalsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([goal_entity_js_1.Goal])],
        controllers: [goals_controller_js_1.GoalsController],
        providers: [goals_service_js_1.GoalsService],
    })
], GoalsModule);
